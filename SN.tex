...
\begin{itemize}
    ...
    \item A shallower network with architecture $784 \to [100] \to 10$ (using Sprecher's theoretical minimum of one hidden layer) achieved approximately 92\% test accuracy.
\end{itemize}
