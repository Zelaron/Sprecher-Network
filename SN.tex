...
\item \textbf{2D case:} A surface such as $f(x,y)=\exp(\sin(\pi x)+y^2)/7$. Once trained for sufficient epochs, good approximation is generally observed after $O(10^5)$ gradient updates. Layerwise spline plots offer an interpretable view of how the network transforms inputs.
\end{itemize}
