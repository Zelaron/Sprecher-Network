...
\begin{itemize}
    ...
    \item A shallower network with architecture $784 \to [100] \to 10$ (using Sprecher's theoretical minimum of one hidden layer, but with significantly fewer than the $2n+1 = 1569$ nodes guaranteed for universality) achieved approximately 92\% test accuracy.
\end{itemize}
