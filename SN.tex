...
\begin{remark}
It is tempting to try to merge the spline pairs in \eqref{eq:two-layer} and \eqref{eq:two-layer} into single composite functions. For example, one might consider replacing the pair
