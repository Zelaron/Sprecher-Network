...
\hline
\textbf{Task} & \textbf{Metric} & \textbf{SN (best)} & \textbf{KAN (best)} & \textbf{Ratio (KAN/SN)} & \textbf{\shortstack{Time\\(KAN/SN) (s)}} \\
\hline
TriWaveMix10D (10D) & RMSE $\downarrow$ & 0.145 & 0.607 & $4.19\times$ & 9{,}831 / 1{,}701 \\
MQSI (20D, 9 heads) & Mean RMSE $\downarrow$ (best of 10 seeds) & $4.47\times 10^{-3}$ & $6.58\times 10^{-3}$ & $1.47\times$ & 393 / 589 (avg) \\
Max-of-Affines8D (8$\to$1) & Best MSE $\downarrow$ (10 seeds) & $6.03\times 10^{-4}$ & $4.45\times 10^{-3}$ & $7.38\times$ & 301 / 142 (avg) \\
Basket options (20$\to$1) & MSE $\downarrow$ & $1.545\times 10^{-3}$ & $2.491\times 10^{-2}$ & 16.1$\times$ & 5{,}366 / 2{,}980 \\
SMAF (20D, 40 comps) & Best val MSE $\downarrow$ (10 seeds) & $4.04\times 10^{-5}$ & $6.38\times 10^{-3}$ & $157.9\times$ & \textemdash \\
DenseHeadShift (12D, 64 heads) & Mean RMSE $\downarrow$ (10 seeds) & $5.47\times10^{-3}$ & $6.94\times10^{-3}$ & $1.27\times$ & 467 / 1{,}433 (avg) \\
PWL sensors (S$^2$HI; 16D) & Best ID MSE $\downarrow$ (10 seeds) & $2.91\times 10^{-2}$ & $5.29\times 10^{-2}$ & $1.82\times$ & \textemdash \\
\hline
\end{tabularx}
