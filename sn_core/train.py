...
def train_network(dataset, architecture, total_epochs=4000, print_every=400, 
    ...
    if TRAIN_PHI_RANGE:
        total_params = lambda_params + eta_params + spline_params + residual_params + output_params + phi_params
    else:
        total_params = lambda_params + eta_params + spline_params + residual_params + output_params
    ...
    if USE_RESIDUAL_WEIGHTS and residual_params > 0:
