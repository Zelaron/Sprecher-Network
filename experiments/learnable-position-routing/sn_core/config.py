...
CONFIG = {
    ...
    'routing_temperature': 1.0,  # Controls sharpness of routing (0.1-10.0)
    'routing_init_noise': 0.1,   # Noise level for initialization
    'routing_circular': True,     # Whether to use circular distance
}
