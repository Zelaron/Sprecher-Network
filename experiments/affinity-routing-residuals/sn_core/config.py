...
CONFIG = {
    ...
    # Routing settings for learnable soft residual connections
    'routing_temperature': 1.0,  # Controls sharpness of soft routing (lower = sharper)
    'routing_init_std': 0.1,    # Standard deviation for routing logit initialization
    'routing_use_importance': True,  # Whether to use importance weighting in pooling
}
