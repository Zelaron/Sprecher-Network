...
def train_network(dataset, architecture, total_epochs=4000, print_every=400, 
    ...
    for name, param in model.named_parameters():
        ...
        elif 'q_scale' in name:
            q_scale_params += param.numel()
    ...
    if CONFIG['train_phi_codomain']:
        total_params = lambda_params + eta_params + q_scale_params + spline_params + residual_params + output_params + codomain_params + norm_params
    else:
        total_params = lambda_params + eta_params + q_scale_params + spline_params + residual_params + output_params + norm_params
    ...
    print(f"  - Q-scale parameters: {q_scale_params}")
