...
Also supports configurable spline order (e.g., cubic B-splines).
"""
...
def train_network(dataset, architecture, total_epochs=4000, print_every=400, 
                  ...
                  residual_style=None, spline_order=1):
    """
    ...
    Args:
        ...
        spline_order: Order of splines (1=Piecewise Linear, 3=Cubic B-Spline). Default: 1
    ...
    # Set spline order in config for global access if needed, though we pass it explicitly
    CONFIG['spline_order'] = spline_order
