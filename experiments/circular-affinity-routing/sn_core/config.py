...
CONFIG = {
    ...
    # Learnable routing settings
    'routing_selectivity_scale': 10.0,  # Maximum selectivity value (higher = more focused routing)
    'routing_temperature': 1.0,  # Softmax temperature for routing weights
    'routing_input_scale': 2.0,  # Maximum input scaling factor for pooling case
    'routing_init_std': 0.0,  # Standard deviation for selectivity initialization (0 = uniform routing initially)
}
