...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Spline order (1=linear, 3=cubic). Default: 1",
    )
...
def get_config_suffix(args, CONFIG):
    ...
    # Check spline order
    if CONFIG.get("spline_order", 1) != 1:
        parts.append(f"Spline{CONFIG['spline_order']}")
...
def main():
    ...
    print(f"Spline order: {CONFIG.get('spline_order', 1)}")
    print(
