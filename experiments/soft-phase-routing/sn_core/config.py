...
CONFIG = {
    ...
    'export_routing_matrices': False,  # Whether to export computed routing matrices
    
    # Learnable routing settings
    'routing_temperature': 1.0,  # Temperature for softmax in routing (higher = more uniform)
    'routing_init': 'uniform',   # Initialization: 'uniform', 'random', 'identity'
    'routing_regularization': 0.0,  # L2 regularization on routing phases (if needed)
}
